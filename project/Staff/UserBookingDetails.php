<?php
	...
	{
	$did=$_GET["did"];
	$update="update tbl_booking set booking_status=2 where booking_id='$did'";
	if(mysql_query($update))
	{
		header('location:ArrivedUsers.php');
	}
	}
    ...
    <td><?php echo $row["booking_children"]?></td>
       <td><?php echo $row["user_name"]?></td>
		...
		?>
         ...
         <td><a href="UserBookingDetails.php?did=<?php echo $row["booking_id"]?>">Arrive</td>
  </tr>
  <?php
  }
  ?>
